...
def extract_offers(provider_id, text):
    """Return only what the official page states verbatim. No inference, no estimates."""
    found = []
    ...
    for provider in providers:
        ...
        try:
            ...
            for attempt in range(EXTRACT_ATTEMPTS):
                ...
                if found or attempt == EXTRACT_ATTEMPTS - 1:
                    break
